        ...
        <div>
          ...
          <div className="projects-grid">
            ...
            <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
              <CardTitle
                style={{
                  color: "black",
                  height: "176px",
                  background: `url("https://www.minttm.com/blog/wp-content/uploads/2019/03/Amazon-Clone.jpg") center / cover`,
                }}
              ></CardTitle>
              <CardText>
            ...
            <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
              ...
              ></CardTitle>
              <CardText>
                Learning new website features(Responsive using bootstrap).
                <br />
                ----------------- Work in Progress! ------------------
              </CardText>
              <CardActions border>
