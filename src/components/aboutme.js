      ...
      <div>
        <Grid>
          ...
          <div>
            ...
            <br/>
              <h3>Interests</h3>
              <p>I love travelling and exploring new places with my family. In the last four years here in the States, I have travelled major plaes from the East Coast(Ocean City, MD) to the west coast(San Francisco, California). 
